...
from flask import Response, render_template, request, json, jsonify,  Response, redirect,session, flash, url_for
...
def course(term="Spring 2019"):
	if term is None:
		term = "Spring 2019"
		classes = Course.objects.order_by("-courseID")
	return render_template('course.html', course = True, courseData = courseData, term = term)
...
@app.route("/user")
def user():
	# User(user_id=1, first_name="pravin", last_name = "singh", email= "pravinc@gmail.com", password = "pravinpassword").save()
	# User(user_id=2, first_name="jay", last_name = "singh", email= "jayc@gmail.com", password = "jaypassword").save()
